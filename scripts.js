//Put at beginning of each option to empty out the old buttons and hide them :) 
...
//The toggle start starts everything, and each option has new toggle option functions inside of them, with more functions inside, so it continues on (because in the old scripts i think the reason it wasn't working is i was trying to put them each individually but I guess I have to repeat them inside each-other?)
function start(){
  
  
  
  
  //Sorry this has become so confusing... I literally spent days/hours on this (and even stayed up working on it 13hours in a row without sleep) and the nar obj structure in my old code (scripts2) wasnt passing into new functions inside of functions.. Idk what I was doing wrong! but, while this one is long and junky, at least it works and I can do better next time... And I am so glad I have it done this is such a stressful semester, yikes.
